    ...
    <section id="Header" class="flex flex-col gap-[100px] bg-portto-black relative">
        <nav class="container max-w-[1130px] mx-auto flex justify-between items-center pt-[30px] z-10">
            ...
            <div class="flex gap-[50px] items-center">
                <ul class="flex gap-[50px] items-center text-white hidden md:flex">
                    ...
                    <button
                        class="bg-portto-light-gold font-bold text-lg p-[14px_30px] rounded-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#FFE7C280] text-black">Hire
                        Me</button>
                </ul>
                <div x-data="{ open: false }" class="relative md:hidden">
                    ...
                    <div x-show="open" x-on:click.away="open = false"
                        class="absolute right-0 mt-[10px] py-[10px] px-[14px] bg-white rounded shadow-lg">
        ...
        <div class="hero container max-w-[1130px] mx-auto flex flex-col md:flex-row justify-between items-center relative">
            <div class="flex flex-col gap-[50px] h-fit w-fit text-white z-10 text-center md:text-left">
                ...
                <button
                    class="font-bold text-[26px] leading-[39px] rounded-[30px] p-[30px_40px] bg-portto-purple w-fit transition-all duration-300 hover:shadow-[0_10px_20px_0_#4920E5] mx-auto md:mx-0">Explore
                    Now</button>
            </div>
        ...
        <div
            class="stats container max-w-[1130px] mx-auto bg-gradient-to-r from-[#FFEDD3] to-[#FFCD83] flex justify-between items-center px-[100px] rounded-[30px] w-full h-[180px] absolute transform -translate-x-1/2 translate-y-1/2 bottom-0 left-1/2 overflow-auto">
