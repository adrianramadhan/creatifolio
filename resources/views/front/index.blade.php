...
@section('title', 'Creatifolio AdrianRamadhan')
@section('content')
<section id="Header" class="flex flex-col gap-[100px] bg-portto-black relative">
    <nav class="container max-w-[1130px] mx-auto flex justify-between items-center pt-[30px] z-10">
        <a href="index.html" class="w-[161px] flex shrink-0 h-fit">
            <img src="{{asset('images/logos/logo.svg')}}" alt="logo">
        </a>
        <div class="flex gap-[50px] items-center">
            <ul class="flex gap-[50px] items-center text-white hidden md:flex">
                <li>
                ...
                <button class="bg-portto-light-gold font-bold text-lg p-[14px_30px] rounded-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#FFE7C280] text-black">Hire Me</button>
            </ul>
            <div x-data="{ open: false }" class="relative md:hidden">
                <button x-on:click="open = !open" class="bg-portto-light-gold font-bold text-lg p-[14px_30px] rounded-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#FFE7C280]">
                    Hire Me
                </button>
                <div x-show="open" x-on:click.away="open = false" class="absolute right-0 mt-[10px] py-[10px] px-[14px] bg-white rounded shadow-lg">
    ...
    <div class="hero container max-w-[1130px] mx-auto flex flex-col md:flex-row justify-between items-center relative">
        <div class="flex flex-col gap-[50px] h-fit w-fit text-white z-10 text-center md:text-left">
            <p class="font-semibold text-2xl">I’m Adrian Ramadhan👋</p>
            <h1 class="font-extrabold text-[80px] leading-[90px]">Professional Software Developer</h1>
            <button class="font-bold text-[26px] leading-[39px] rounded-[30px] p-[30px_40px] bg-portto-purple w-fit transition-all duration-300 hover:shadow-[0_10px_20px_0_#4920E5] mx-auto md:mx-0">Explore Now</button>
        </div>
        <div class="flex max-w-[471px] max-h-[567px] z-10 mt-6">
            <img src="{{asset('images/pp.png')}}" class="w-full h-full object-contain" alt="hero image">
        </div>
    ...
    <div class="stats container max-w-[1130px] mx-auto bg-gradient-to-r from-[#FFEDD3] to-[#FFCD83] flex justify-between items-center px-[100px] rounded-[30px] w-full h-[180px] absolute transform -translate-x-1/2 translate-y-1/2 bottom-0 left-1/2 overflow-auto">
        <div class="text-center w-fit h-fit mx-4">
        ...
        <div class="text-center w-fit h-fit mx-4">
            ...
            <p class="font-semibold text-lg mx-4">Successful</p>
        </div>
        <div class="text-center w-fit h-fit mx-4">
    ...
    <div class="container max-w-[1130px] mx-auto flex justify-between pt-[100px] pb-[50px] mb-[50px] relative border-b border-[#585867]">
        ...
        <div class="flex gap-[100px] z-10">
            ...
            <div class="flex flex-col gap-5">
                ...
                <a href="" class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img src="{{asset('images/icons/dribbble.svg')}}" alt="icon">AdrianRamadhan</a>
                <a href="" class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img src="{{asset('images/icons/sms.svg')}}" alt="icon">team@adrian.com</a>
            </div>
        </div>
    </div>
    <p class="text-sm text-[#A0A0AC] text-center">All Rights Reserved. Copyright AdrianRamadhan 2024.</p>
</footer>
